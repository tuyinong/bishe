                    ...
                    <form action="" class="form" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-8 col-sm-6">
                                <input class="form-control" type="text" name="a_account" id="account" placeholder="请输入管理员账号" value="<?php echo ($info["a_account"]); ?>">
                            </div>
                        </div>
                        <!-- 管理员密码 -->
                        <div class="form-group row">
                            ...
                            <div class="col-xs-8 col-sm-6">
                                <input class="form-control" type="password" name="a_pwd" id="pwd" placeholder="请输入管理员密码" value="123456">
                            </div>
                        </div>
                        <!-- 按钮 -->
