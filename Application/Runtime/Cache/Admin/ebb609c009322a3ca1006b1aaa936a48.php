...
<script>
    ...
    <div class="body">
        <div class="box">
            ...
            <div class="rowbox">
                <div class="add" onclick="javascript:document.location.href='/index.php/Admin/Award/addaward'">
                    <img src="/Application/Public/img/addimg.jpg" alt="">
                </div>
            </div>
            <div class="rowbox">
                <div class="tablebox">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><img style="width:50px;" src="<?php echo ($vo["img"]); ?>" alt=""></td>
                                    <td>
                                        <!-- <button class="btn btn-primary">查看信息</button> -->
                                        <button class="btn btn-danger" onclick="awarddel('<?php echo ($vo["id"]); ?>')">删除</button>
                                    </td>
