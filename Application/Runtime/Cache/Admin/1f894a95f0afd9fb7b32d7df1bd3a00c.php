                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php if(is_array($noticelist)): $i = 0; $__LIST__ = $noticelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    <td>
                                        <?php if(($$vo["n_state"]) == "1"): ?>已发送
                                            <?php else: ?> <p style="color:red">消息未发送</p><?php endif; ?>
                                    </td>
                                    <td><?php echo ($vo["n_sendtime"]); ?></td>
                                    <td><?php echo ($vo["n_title"]); ?></td>
                                    <td><?php echo ($vo["n_content"]); ?></td>
                                    <td><?php echo ($vo["object"]); ?></td>
                                    <td>
                                        <?php if(($$vo["n_state"]) == "1"): ?><button class="btn btn-primary">消息详情</button>
                                            <?php else: ?><button class="btn btn-primary">重新编辑</button>
                                            <button class="btn btn-danger">取消发送</button><?php endif; ?>
                                    </td>
