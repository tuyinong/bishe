            ...
            <div class="rowbox">
                <div class="col-xs-12" >
                    <form action="" class="form-inline" method="post">
                        ...
                        <input type="text" name="name" id="name" placeholder="请输入买家昵称" value="<?php echo ($info["name"]); ?>" class="form-control">
                        <label for="content">评价内容:</label>
                        <input type="text" name="content" id="content" placeholder="请输入评价内容" value="<?php echo ($info["content"]); ?>" class="form-control">
