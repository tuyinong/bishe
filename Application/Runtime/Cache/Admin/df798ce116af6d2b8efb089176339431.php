                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php if(is_array($goodslist)): $i = 0; $__LIST__ = $goodslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td>
                                        <button class="btn btn-primary" onclick="changestate(<?php echo ($vo["id"]); ?>)">重新审核</button>
                                        <button class="btn btn-primary" onclick="send('<?php echo ($vo["from_id"]); ?>')">联系卖家</button>
                                    </td>
