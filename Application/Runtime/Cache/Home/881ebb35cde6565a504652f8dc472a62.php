...
<body>
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="row" style="margin:5px;" onclick="javascript:document.location.href='/index.php/Home/Goods/buy?uid=<?php echo (session('uid')); ?>&gid=<?php echo ($gid); ?>&aid=<?php echo ($vo["id"]); ?>'">
